...
df <- tribble(
  ...
  mutate(
    ...
    Status = ifelse(Repo %in% c("dynwrap", "dynmethods", "dynplot", "dynutils", "dynnormaliser", "dyntoy"), glue::glue("[![Build status](https://travis-ci.org/dynverse/{Repo}.svg?branch=master)](https://travis-ci.org/dynverse/{Repo})"), "Coming soon")
  ) %>% 
