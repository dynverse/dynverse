...
df <- tribble(
  ...
  mutate(
    ...
    Status = ifelse(!Repo %in% c(), glue::glue("[![Build status](https://travis-ci.org/dynverse/{Repo}.svg?branch=master)](https://travis-ci.org/dynverse/{Repo})"), "Coming soon"),
    `Code coverage` = ifelse(!Repo %in% c(), glue::glue("[![codecov](https://codecov.io/gh/dynverse/{Repo}/branch/master/graph/badge.svg)](https://codecov.io/gh/dynverse/{Repo})"), "")
  ) %>% 
